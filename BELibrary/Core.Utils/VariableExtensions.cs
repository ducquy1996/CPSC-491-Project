...
namespace BELibrary.Utils
{
    ...
    public static class LangCode
    {
        ...
        public static List<SelectListModel> GetDic()
        {
            return new List<SelectListModel>() {
                new SelectListModel{Key="vi",Value="Vietnamese" },
                new SelectListModel{Key="en",Value="English" },
                new SelectListModel{Key="ja",Value="Japanese" }
            };
        }
    }
    ...
    public static class RoleKey
    {
        ...
        {
            return new List<SelectListModel>() {
                new SelectListModel{Key=1,Value="Admin" },
                new SelectListModel{Key=2,Value="Teacher" },
                new SelectListModel{Key=3,Value="Student" }
            };
        }
    }
